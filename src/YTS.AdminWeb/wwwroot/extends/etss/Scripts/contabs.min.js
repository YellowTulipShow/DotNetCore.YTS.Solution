$(function () {
    ...
    window.J_menuItem_click = function () {
                ...
                if (!$(this).hasClass("active")) {
                    ...
                    $(".J_mainContent .J_iframe").each(function () {
                        if ($(this).data("id") == o) {
                            ...
                            this.contentWindow.location.href = o;
                            //this.contentWindow.location.reload();
                            return false
                        }
                    })
                } else {
                    $('.J_iframe:visible').get(0).contentWindow.location.href = o;
                    //$('.J_iframe:visible').get(0).contentWindow.location.reload();
                }
                k = false;
                return false
            }
    ...
    $(".J_tabRefresh").on("click", function () { $('.J_iframe:visible').get(0).contentWindow.location.reload() });
