...
namespace YTS.Logic.Data
{
    ...
    public static class CheckData
    {
        ...
        public static bool IsNumber(object o)
        {
            ...
            return int.TryParse(o.ToString(), out _);
        }
        ...
        /// 检查空值赋予更新值
        /// </summary>
        public static string CheckNull(this string oldValue, string newValue)
        {
        ...
        /// 检查空值赋予更新值
        /// </summary>
        public static T? CheckNull<T>(this T? oldValue, T? newValue) where T : struct => newValue ?? oldValue;
