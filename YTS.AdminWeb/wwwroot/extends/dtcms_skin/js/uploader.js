$(function () {
    ...
    $.fn.InitUploader = function (b) {
        var fun = function (parentObj) {
            ...
            if (p.circleoffriends) {
                p.sendurl += "&IsCircleOfFriends=1";
                p.sendurl += "&PathSection=" + p.pathsection
            }
            ...
            uploader.on('uploadError', function (file, reason) {
                p.event.uploadError(file, reason);
            ...
            uploader.on('uploadSuccess', function (file, data) {
                p.event.uploadSuccess(file, data);
                ...
                if (data.status == '1') {
                    ...
                    if (!p.multiple) {
                        ...
                        try {
                            parentObj.siblings(".upload-path").attr('src', data.path);
                        }
                        catch (err) {
                            console.log(err);
                        }
