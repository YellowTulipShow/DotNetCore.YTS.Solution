            ...
            that.on('mousedown.DDSort', settings.target, function (e) {
                ...
                $doc.on('mousemove.DDSort', function (e) {
                    ...
                    if (top < thatOffsetTop) {
                        ...
                        if (thatScrollTop - lastNum > upSpeed) {
                            console.log("%c err", "background:#000;color:#fff");
                            return;
                        }
                        ...
                        console.log("%c " + thatScrollTop, "color:red");
