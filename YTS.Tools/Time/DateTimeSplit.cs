...
namespace YTS.Tools
{
    ...
    public class DateTimeSplit
    {
        ...
        /// <returns>结果</returns>
        public static DateTime GoBackTime(DateTime time, ESection section, int stepLength)
        {
        ...
        /// <param name="stepLength">操作的步长</param>
        /// <returns>结果</returns>
        public static DateTime GoAhead(DateTime time, ESection section, int stepLength)
        {
            return GoSetTime(time, section, -stepLength);
        }
        ...
        /// <param name="time">时间</param>
        /// <returns>结果</returns>
        public static MTime GoBackTime(MTime time)
        {
        ...
        /// <param name="time">时间</param>
        /// <returns>结果</returns>
        public static MTime GoAhead(MTime time)
        {
            TimeSpan span = time.End - time.End;
            return new MTime()
            {
                Start = time.End,
